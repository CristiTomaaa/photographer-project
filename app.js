function init() {
  ...
  function nextSlide(pageNumber) {
    ...
    tl.fromTo(currentLeft , 0.3, {y:'-10%'}, {y: '-100%'})
      ...
      .fromTo(currentPage, 0.3, {opacity: 1, porinterEvents: 'all'}, {opacity: 0, porinterEvents: 'none'})
      .fromTo(nextPage, 0.3, {opacity: 0, porinterEvents: 'all'}, {opacity: 1, porinterEvents: 'none'}, '-=0.6s')
